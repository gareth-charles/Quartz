...
L["Distance between icons and swing bars"] = "Abstand zwischen Symbolen und Schwenkbalken"
L["%dms"] = "%dms"
L["Down"] = "Nach unten"
...
L["Pet"] = "Begleiter"
L["Pick the size of the icon"] = "Wählen Sie die Größe des Symbols"
...
L["Set the color of the swing timer bar for auto shot"] = "Stellen Sie die Farbe der Swing-Timerleiste für die automatische Aufnahme ein"
...
L["Shows weapon icons to differentiate ranged and melee"] = "Zeigt Waffensymbole zur Unterscheidung von Fernkampf und Nahkampf an"
