...
L["Distance between icons and swing bars"] = "图标和摇杆之间的距离"
L["%dms"] = "%dms"
L["Down"] = "向下"
L["Duel Request"] = "决斗申请"
...
L["Party Invite"] = "队伍邀请"
L["Pet"] = "宠物"
L["Pick the size of the icon"] = "选择图标的大小"
L["Player"] = "玩家"
...
L["Set the color of the swing timer bar for auto shot"] = "定義自動拍攝的條形顏色"
...
L["Shows weapon icons to differentiate ranged and melee"] = "显示武器图标以区分远程和近战"
