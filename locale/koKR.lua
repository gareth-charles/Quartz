...
L["Distance between icons and swing bars"] = "아이콘과 스윙 바 사이의 거리"
L["%dms"] = "%dms"
L["Down"] = "아래로"
...
L["Pet"] = "소환수"
L["Pick the size of the icon"] = "아이콘 크기 선택"
L["Player"] = "플레이어"
L["Poison Color"] = "독 색상"
L["Position"] = "위치"
...
L["Shows weapon icons to differentiate ranged and melee"] = "원거리와 근거리를 구분하기 위해 무기 아이콘을 표시합니다."
