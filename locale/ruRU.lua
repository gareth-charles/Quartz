...
L["Distance between icons and swing bars"] = "Расстояние между значками и поворотными полосами"
L["%dms"] = "%dмс"
L["Down"] = "Низ"
...
L["Enable Icons"] = "Включить значки"
...
L["Pet"] = "Питомец"
L["Pick the size of the icon"] = "Выберите размер значка"
L["Player"] = "Игрок"
...
L["Shows weapon icons to differentiate ranged and melee"] = "Отображает значки оружия, чтобы различать дальний и ближний бой"
