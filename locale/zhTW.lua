...
L["Distance between icons and swing bars"] = "圖標和搖桿之間的距離"
L["%dms"] = "%dms"
L["Down"] = "下"
L["Duel Request"] = "決鬥要求"
...
L["Party Invite"] = "小隊邀請"
L["Pet"] = "寵物"
L["Pick the size of the icon"] = "選擇圖標的大小"
L["Player"] = "玩家"
...
L["Set the color of the swing timer bar for auto shot"] = "???"
...
L["Shows weapon icons to differentiate ranged and melee"] = "顯示武器圖標以區分遠程和近戰"
