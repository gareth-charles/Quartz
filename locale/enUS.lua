...
L["Distance between icons and swing bars"] = true
L["%dms"] = true
L["Down"] = true
L["Duel Request"] = true
...
L["Party Invite"] = true
L["Pet"] = true
L["Pick the size of the icon"] = true
L["Player"] = true
L["Poison Color"] = true
L["Position"] = true
...
L["Set the color of the swing timer bar for auto shot"] = true
...
L["Shows weapon icons to differentiate ranged and melee"] = true
...
L["Toggle display of swing bars to always on"] = true
